...
Page({
  ...
  onLoad: function () {
    ...
    var _this = this;
    var checkLoginInterval = setInterval(init, Config.checkLoginUserCycleTime);
  ...
  doFormSubmit: function (e) {
    var currentUserName= e.detail.value.name;
    var _this = this;
          ...
          wx.request({
            ...
            success: function (res) {
              ...
              if (res.data == 1) {
                ...
                Storage.set('currentUserName', currentUserName);
                console.log("页面跳转");
                wx.redirectTo({
                  url: '../home/home'
                })
